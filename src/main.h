...
static const int64 MAX_MINT_PROOF_OF_WORK = 88 * COIN;//Init 88 coins per block
...
static const uint256 hashGenesisBlockOfficial("0x3d1737574c3b08d8eb2fe452afe7cf5fcb30fe94f6d0459792d0c271eecaa041");
...
// freecoin: calculate Nfactor using timestamp
...
public:
    ...
    */
    ...
    /** Amount of freecoins spent by this transaction.
    ...
    /** Amount of freecoins coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at freecoin block #9689
        //if (nHeight >= 9689)
        {
        ...
        /*// Before freecoin block #9689 - old protocol
