...
static const char *strDNSSeed[][2] = {
    {"freecoin.com", "seeds.freecoin.com"},
    {"freecoin.org", "seed1.freecoin.org"},
    {"freecoin.org", "seed2.freecoin.org"}
};
...
void StartNode(void* parg)
{
   ...
   if (!GetBoolArg("-dnsseed", true))
    ...
    GenerateFreecoins(GetBoolArg("-gen", false), pwalletMain);
}
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) printf("ThreadFreecoinMiner still running\n");
