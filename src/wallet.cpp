    ...
    try
    {
        ...
        CTxDB txdb("r");
        {
            ...
            loop
            {
                ...
                {
                    //// debug print //add by freecoin-dev
                    //printf("SelectCoins(nTotalValue=%d,wtxNew.nTime=%d) failed.\n",nTotalValue,wtxNew.nTime);
                    return false;
                }
                ...
                {
                    //add by freecoin-dev
                    //printf("nBytes=%d >= MAX_BLOCK_SIZE_GEN/5=%d.\n",nBytes,MAX_BLOCK_SIZE_GEN/5);
                    return false;
                }
                dPriority /= nBytes;
...
bool CWallet::CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64 nSearchInterval, CTransaction& txNew)
{
    ...
    static unsigned int nStakeSplitAge = nStakeMaxAge;
